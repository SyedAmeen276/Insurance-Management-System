            ...
            <div class = "container">
                ...
                <div class = "form_group">    
                    ...
                    <input type = "date" name = "DOC" value = "" required />    
						...
						<div class = "form_group">    
                    <label>Type:</label>    
					<input type = "radio" name = "Product" value = "" required />Health
					<input type = "radio" name = "Product" value = "" required />Bike
					<input type = "radio" name = "Product" value = "" required />Car
					<input type = "radio" name = "Product" value = "" required />Life
				<div class = "form_group">    
