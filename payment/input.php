<?php
		...
		if($pay=='Yes'){
			$d=date("Y-m-d");
			$r=time()%(100000000000);
			$query="insert into paid(Receipt_Num,Receipt_Date,Policy_Num) values('$r','$d','$pn')";
			...
			$query3="update paid set STATUS='paid' where Policy_Num='$pn' ";
			...
			$f=$late*50;
			$query1="insert into unpaid_premium(Policy_Num,STATUS) values('$pn','unpaid')";
